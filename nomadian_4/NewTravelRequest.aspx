<%@ Page Title="Create a New Request" Language="C#" MasterPageFile="~/Profile.Master" AutoEventWireup="true" CodeBehind="NewTravelRequest.aspx.cs" Inherits="nomadian_4.NewTravelRequest" %>
...
<br /><br /><br />
  <div class="container card" style="width: 31rem;">
    <div class="card-body">
        <div class="card-title text-center">
           <h2> Create a New Travel Request</h2>
        </div>
        <hr />
        <div class="row">
            ...
            <!--
              <div class="form-row"> 
                <div class="form-group col-lg-6">
                  ...
                  <asp:TextBox ID="requestEmail" CssClass="form-control" textmode="Email" runat="server"></asp:TextBox>
                </div>

                <div class="form-group col-lg-6">
                  <label for="inputPassword4">Password</label>                  
                    <asp:TextBox ID="requestPassword" CssClass="form-control" textmode="Password" runat="server"></asp:TextBox>
                </div>
              </div>
                <hr />
            <hr />-->
              <div class="form-group">
                <label for="countryTravelRequest">Purpose of Visit</label>
                   <asp:TextBox ID="purposeVisit" Width="400" TextMode="MultiLine" CssClass="form-control"  runat="server"></asp:TextBox>
              </div>
            </div>
              <div class="form-group">
                <label for="dropdownCountryTravelRequest">Country :- </label>
                 &nbsp;
                    <asp:DropDownList ID="countryDropDownListTravelRequest" width="350" CssClass="btn border-secondary rounded dropdown-toggle" runat="server">
              ...
              <div class="form-row">
                <div class="form-group col-lg-6">
                  <label for="startingDate">Starting Date</label>
                    ...
                    <asp:TextBox ID="startDate" CssClass="form-control" textmode="Date" runat="server"></asp:TextBox>
                </div>
                
                <div class="form-group col-lg-6">
                  <label for="endingDate">Ending Date</label>
               
                    <asp:TextBox ID="endDate" CssClass="form-control" textmode="Date" runat="server"></asp:TextBox>
                </div>
              </div>
              <div class="form-group text-center">
                ...
                <div class="form-groupmr text-center">
                    <asp:Button ID="submitTravelRequest" runat="server" Text="Create Request" class="btn btn-primary" OnClick="submitTravelRequest_Click"></asp:Button>
                </div>
